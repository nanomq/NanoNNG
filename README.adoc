...
NNG has been ported to the https://www.zephyrproject.org/[Zephyr RTOS].
See the <<docs/BUILD_ZEPHYR.md#,Zephyr Build Guide>> for environment setup,
build instructions, and demo applications.
