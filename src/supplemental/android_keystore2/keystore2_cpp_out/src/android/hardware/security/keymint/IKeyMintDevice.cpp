...
static binder_status_t _aidl_android_hardware_security_keymint_IKeyMintDevice_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 17 /*setAdditionalAttestationInfo*/): {
      std::vector<::aidl::android::hardware::security::keymint::KeyParameter> in_info;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_info);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->setAdditionalAttestationInfo(in_info);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
::ndk::ScopedAStatus BpKeyMintDevice::setAdditionalAttestationInfo(const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_info) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 17 /*setAdditionalAttestationInfo*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    FLAG_CLEAR_BUF
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeyMintDevice::getDefaultImpl()) {
    _aidl_status = IKeyMintDevice::getDefaultImpl()->setAdditionalAttestationInfo(in_info);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
std::shared_ptr<IKeyMintDevice> IKeyMintDevice::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz)) {
...
::ndk::ScopedAStatus IKeyMintDeviceDefault::setAdditionalAttestationInfo(const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& /*in_info*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
