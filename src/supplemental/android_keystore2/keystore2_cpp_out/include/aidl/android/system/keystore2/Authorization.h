...
public:
  ...
  inline bool operator==(const Authorization& _rhs) const {
    return std::tie(securityLevel, keyParameter) == std::tie(_rhs.securityLevel, _rhs.keyParameter);
  }
  inline bool operator<(const Authorization& _rhs) const {
    return std::tie(securityLevel, keyParameter) < std::tie(_rhs.securityLevel, _rhs.keyParameter);
  }
