...
mqtt_tcptran_ep_set_reconnect_backoff(void *arg, const void *v, size_t sz, nni_opt_type t)
{
	...
	// max backoff time cannot exceed 10min(360s)
...
static int
mqtt_tcptran_ep_set_nolocal_v4(void *arg, const void *v, size_t sz, nni_opt_type t)
{
	mqtt_tcptran_ep *ep = arg;
	bool             tmp;
	int              rv;
...
static const nni_option mqtt_tcptran_ep_opts[] = {
	...
	},
	{
	    ...
	    .o_set  = mqtt_tcptran_ep_set_nolocal_v4,
	},
	// terminate list
	{
	    .o_name = NULL,
