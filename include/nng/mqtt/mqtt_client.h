...
#define CMD_PUBLISH_V5_RECV 0x32 // Flag indicate V5 Publish msg recived from upstream as bridge
...
NNG_DECL void nng_mqtt_set_sqlite_conf(nng_mqtt_sqlite_option *opt,
    void *config, const char *bridge_name, uint8_t pro_ver, void *conf_sqlite);
